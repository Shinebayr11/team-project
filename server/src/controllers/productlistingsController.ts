...
/**
 * Дамжуулалтын аукционууд. live_show_id өгвөл зөвхөн тухайн дамжуулалтынх, эс бөгөөс бүгд.
...
export const getMySales = async (c: Context) => {
    try {
        ...
        // Дамжуулалт нь худалдагчийнх эсэхээр шүүнэ — лот дээр эзэмшигч шууд байхгүй.
...
/**
 * Дамжуулалт дээр бараагаа аукционд гаргах. Зөвхөн тухайн дамжуулалтын эзэн, зөвхөн
 * өөрийн бараагаар.
 */
export const postProductlisting = async (c: Context) => {
    try {
        ...
        // Нэг дамжуулалт дээр нэгэн зэрэг зөвхөн нэг аукцион явна — үзэгчид юун дээр
...
/** Аукционыг хугацаанаас нь өмнө хаах — зөвхөн дамжуулалтын эзэн. */
