 ...
 * held_coins) хүрэлцэж байвал л амжилттай — иймд нэг дүнг зэрэг явж буй
 ...
 * давах буюу байхгүй үлдэгдэл үүснэ — иймд барьцаа хүрэлцэхэд л хасна.
 */
    ...
    for (const listing of expired) {
      ...
      try {
        ...
        if (!buyerWallet) {
            ...
            // releaseCoins дуудвал байхгүй барьцааг хасаж, үлдэгдэл үүсгэнэ.
        ...
        //
        // Төлбөр нь ЭНД аль хэдийн хийгдсэн (үлдэгдэл шилжсэн); хүргэлт эхлээгүй.
