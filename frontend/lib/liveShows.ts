...
export const toHomeShow = (doc: LiveShowDoc): HomeShow => {
  ...
  return {
    ...
    showId: doc._id,
    // `/sell`-ээс эхлүүлсэн дамжуулалт `started_at`-гүй үүсэж болох тул `createdAt`
...
// харуулж чадахгүй — тиймээс бодит room-той (roomId) дамжуулалтыг зөвхөн жинхэнэ
// видео дэлгэц рүү, roomId-гүй (mock/жишээ) дамжуулалтыг Browse рүү оруулна.
//
