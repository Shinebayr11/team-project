...
**Харилцан үйлдэл** нь гурван үүрэгтэй, тус бүр өөр хэлбэртэй:

| Үүрэг | Токен | Хаана |
|---|---|---|
| Гадаргуу дээрх гол үйлдэл | `--wn-admin-lime` | Хадгалах, илгээх, идэвхтэй зураас |
| Сонгогдсон зүйл | `--wn-admin-ink` | Цэс, таб, сегмент |
| Бичвэрийн үйлдэл | `--wn-admin-accent` | Холбоос, сонгогдсон дүрс |
...
| Товч | `btn(tone, size)` — `components/buttons.ts` |
