...
export const useHomeFeed = (query: string, category: string, statusFilter: StatusFilter = null) => {
  ...
  const hottestShow = useMemo(() => {
    ...
    // Дөнгөж эхэлсэн шууд дамжуулалт 0 үзэгчтэй байдаг тул зөвхөн үзэгчээр эрэмбэлбэл
    // үзэгч хуримтлуулсан хуучин мөрөнд үргэлж хожигдож, ЯГ ОДОО явж байгаа шууд дамжуулалт
