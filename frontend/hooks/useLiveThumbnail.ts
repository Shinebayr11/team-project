...
/**
 * Худалдагчийн камерын нэг кадрыг тогтмол авч, шууд дамжуулалтын `thumbnail_url` болгоно.
 *
  ...
  useEffect(() => {
    ...
    const capture = async () => {
      ...
      try {
        ...
        // Урьдчилсан зураг бол чимэглэл — амжилтгүй болсон нь шууд дамжуулалтад
