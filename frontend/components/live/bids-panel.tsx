 ...
 * тухайн таб дээрээ шилжвэл LiveKit-ийн холболт тасарч, шууд дамжуулалт унана.
 */
  ...
  if (!products.length) {
    return (
      <div className="p-4 text-[13px] text-[var(--wn-ink-3)]">
        {error ?? "Бараа алга. Эхлээд шууд дамжуулалт эхлэх хуудаснаас бараагаа бүртгээрэй."}
      </div>
    )
  }
  ...
  return (
    <div className="flex flex-col gap-3 p-3">
      {/* Нэрийн жагсаалт (select) байхад аль бараагаа гаргаж байгаагаа
          шууд дамжуулалтын явцад ялгахад хэцүү — зурагтай нь харуулна. */}
      <div
        role="radiogroup"
        aria-label="Бараа"
