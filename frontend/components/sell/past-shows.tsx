...
/**
 * Худалдагчийн хамгийн их үзэлттэй 3 шууд дамжуулалт. Шинэ шууд дамжуулалт эхлэхийн өмнө хамгийн
    ...
    >
      <div>
        <h2 className="text-[16px] font-[800] text-black">
          Хамгийн их үзэлттэй шууд дамжуулалтууд
        </h2>
        <p className="mt-1 text-[14px] font-[500] text-gray-500">
          Өмнөх шууд дамжуулалтуудаасаа хамгийн амжилттай 3-ыг харна уу.
        </p>
      </div>
        ...
        {loading ? (
          ...
          <div className="rounded-xl border border-dashed border-gray-300 p-6 text-center">
            ...
            <p className="mt-2 text-[14px] font-[500] text-gray-500">
              Дуусгасан шууд дамжуулалт байхгүй байна.
            </p>
          </div>
        ) : (
          shows.map((show) => (
