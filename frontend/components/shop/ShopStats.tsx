...
export const ShopStats: React.FC<{ seller: SellerRecord }> = ({ seller }) => (
  <div className="px-4 sm:px-6 lg:px-8 max-w-[800px] mb-8">
    <p className="text-[15px] text-[var(--wn-ink-2)] leading-relaxed mb-6">{seller.bio}</p>
    {/* Дөрвөн үзүүлэлт + гурван цэг 320px дээр нэг мөрөнд багтахгүй. */}
    <div className="flex flex-wrap items-center gap-x-4 gap-y-2 sm:gap-6 text-[14px]">
