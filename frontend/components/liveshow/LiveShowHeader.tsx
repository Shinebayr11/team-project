...
export function LiveShowHeader({ showId }: LiveShowHeaderProps) {
  ...
  // Шууд дамжуулалтын мэдээлэл нэг л удаа — 5 секунд тутам дахин татах шаардлагагүй.
  useEffect(() => {
    let cancelled = false
    callApi<{ data: ShowData }>(`/api/liveshow/${showId}`)
      ...
      .catch((err) => console.error('Шууд дамжуулалтын мэдээлэл татаж чадсангүй:', err))
      .finally(() => {
  ...
  // Өөрийнхөө шууд дамжуулалт дээр "дагах" товч утгагүй — сервер ч 400 буцаадаг.
