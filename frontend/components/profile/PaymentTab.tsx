...
export const PaymentTab: React.FC = () => (
  <div className="flex flex-col gap-6 max-w-[600px]">
    <h2 className="text-[24px] font-[800] text-[var(--wn-ink)]">Төлбөрийн хэрэгсэл</h2>
    ...
    <div className="p-6 rounded-2xl border border-[var(--wn-line)] bg-white flex items-center justify-between">
      <div className="flex items-center gap-4">
        ...
        <div>
          <div className="text-[15px] font-[700] text-[var(--wn-ink)]">Visa •••• 4242</div>
          <div className="text-[13px] text-[var(--wn-ink-3)]">Дуусах хугацаа 12/25</div>
        </div>
      </div>
