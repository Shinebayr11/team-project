...
export const OverviewTab: React.FC<OverviewTabProps> = ({
  ...
  <div className="flex flex-col gap-10">
    ...
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
      ...
      <StatCard value={savedShows.length} label="Хадгалсан дамжуулалт" onClick={() => onNavigate('saved')} />
    ...
    {savedShows.length > 0 && (
      <div>
        <SectionHeader title="Хадгалсан дамжуулалт" onViewAll={() => onNavigate('saved')} />
